"""Average daily consumption sensor for Heat Cost Allocator."""
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    """Set up the average daily consumption sensor from a config entry."""
    prefix = config_entry.data.get("prefix", "")
    area_id = config_entry.data.get("area")
    sensor = HeatCostAllocatorAverageDailyConsumption(
        hass, prefix, config_entry.entry_id, area_id
    )
